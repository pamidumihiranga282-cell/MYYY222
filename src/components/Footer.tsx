        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-amber-200/60">
              <li>Up to 250G → <span className="text-amber-400 font-medium">Rs. 250</span></li>
              <li>Up to 500G → <span className="text-amber-400 font-medium">Rs. 350</span></li>
              <li>Up to 1KG → <span className="text-amber-400 font-medium">Rs. 450</span></li>
              <li>Over 1KG → <span className="text-amber-400 font-medium">+ Rs. 100/500g</span></li>
            </ul>
